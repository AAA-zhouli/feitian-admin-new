package com.feitian.admin.config.shiro;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultSecurityManager securityManager, Realm realm) {
		...
		List<com.feitian.admin.entity.Resource> list = resourceService.findAll();
		for (com.feitian.admin.entity.Resource resource : list) {
