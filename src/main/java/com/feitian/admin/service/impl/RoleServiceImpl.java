...
import com.feitian.admin.common.Constats;
import com.feitian.admin.dao.IRoleDao;
...
import com.feitian.admin.service.IResourceService;
import com.feitian.admin.service.IRoleService;
...
public class RoleServiceImpl extends BaseServiceImpl<Role, Integer> implements IRoleService {
	...
	public void grant(Integer id, String[] resourceIds) {
		...
		Assert.state("administrator".equals(role.getRoleKey()),"非超级管理员角色不能进行资源分配");
		Resource resource;
