								...
								<div>
									<form id="ffSearch">
										<table style="width: 90%;margin-bottom: 20px;">
											<tr>
												<td style="text-align: right">款号：</td>
												<td><input type="text" name="styleNumber" class="form-control"/>
												<td style="text-align: right">订单状态：</td>
												<td><select name="orderStatus" class="form-control">
                                                    <option value="">全部</option>
                                                    <option value="0">系统处理中</option>
                                                    <option value="1">未发货</option>
                                                    <option value="2">已发货</option>
                                                </select></td>
												<td style="text-align: right">店铺名称：</td>
												<td><input type="text" name="shopName" class="form-control" /></td>
												<td style="text-align: right"><input type="button" onclick="search()" class="btn btn-info" value="查询"/></td>
											</tr>
										</table>
									</form>
        ...
        $(document).ready(function () {
			...
			$("#table_list").bootstrapTable({
                ...
                queryParams : function (params) {
                    ...
                    temp["sortName"] = params.sort;                         //排序列名
			    ...
			    columns: [{
                    ...
                    formatter: function(value,row,index){
                        if(value == 0)
                            return '<span class="label label-info">系统处理中</span>';
                        else if(value == 1)
