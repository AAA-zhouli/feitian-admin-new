            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">FeiTianAdmin</strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                        <div class="logo-element">FeiTianAdmin
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                         <@shiro.hasPermission name="trade:flow:index">
                            <li>
                                <a class="J_menuItem" href="${ctx!}/trade/flow/index">交易流水</a>
                            </li>
                         </@shiro.hasPermission>
                         <@shiro.hasPermission name="admiin:salesStatistics:index">
                            <li>
                                <a class="J_menuItem" href="${ctx!}/admin/salesStatistics/index">数据统计</a>
                            </li>
                         </@shiro.hasPermission>
                        </ul>
                    </li>
